...
<script type="text/javascript" charset="utf-8" src="<?php echo base_url("assets/js/farbtastic.js"); ?>"></script>
<script>
        ...
        <div class="col-md-12 column">
            <div class="tabbable" id="tabs-110046">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#panel-color-table" data-toggle="tab">color table reference</a>
                    </li>
                    <li>
                        <a href="#panel-color-convert" data-toggle="tab">color convert</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane" id="panel-color-convert">
                        <p>
                            <form action="" class="well form-inline" style="width:240px;align: center;">
                                ...
                                <div class="form-item">
                                    <div class="input-prepend">
                                        <span class="add-on">颜色值：</span>
                                        <input class="span2" type="text" id="color" name="color" value="#123456" style="color: rgb(255, 255, 255); background-color: rgb(18, 52, 86);">
                                    </div>
                                </div>
                                <div class="form-item">
                                    <div class="input-prepend">
                                        <span class="add-on">RGB 整数值：</span>
                                        <input class="span2" type="text" id="color" name="color" value="#123456" style="color: rgb(255, 255, 255); background-color: rgb(18, 52, 86);">
                                    </div>
                                </div>
                                <div class="form-item">
                                    <div class="input-prepend">
                                        <span class="add-on">RGB 浮点数：</span>
                                        <input class="span2" type="text" id="color" name="color" value="#123456" style="color: rgb(255, 255, 255); background-color: rgb(18, 52, 86);">
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="tab-pane active" id="panel-color-table">
                        <p>
